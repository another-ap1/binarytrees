...
class BinarySearchTree {
  ...
  insert(val) {
    //if tree is emtpy it will do this
    if(this.root === null){
      this.root = new Node(val);
      return this;
    }

    //if there is a root val then it will insert with the following
  ...
  insertRecursively(val, current=this.root) {
    // If the tree is empty it will insert at the root
    if(this.roo==null){
      this.root = new Node(val);
      return this;
    }
    
    // if the tree is not emppty it will run this
    if(val<current.val) {
      if(current.left===null) {
        current.left = new Node(val);
        return this;
